...
export function ProductDealCard({ product }: { product: Product }) {
  ...
  return (
    <Link
      ...
      className="group bg-card relative flex w-[160px] shrink-0 flex-col overflow-hidden rounded-lg border border-zinc-200 shadow-sm transition hover:border-mm-primary/40 hover:shadow-md md:w-[180px]"
    >
      <Badge
        color="accent"
        size="sm"
